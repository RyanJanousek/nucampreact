...
const mapDispatchToProps = {
    ...
    restFeedbackForm: () => (actions.reset('feedbackForm')),
        ...
        const CampsiteWithId = ({ match }) => {
            return (
                <CampsiteInfo campsite={this.props.campsites.campsites.filter(campsite => campsite.id ===
                    ...
                    commentsErrMess={this.props.addComment}
                ...
                <TransitionGroup>
                    <CSSTransition key={this.props.location.key} classNames="page" timeout={300}>
                        <Switch>
                            ...
                            <Route exact path='/contactus' render={() => < Contact postFeedback={this.props.postFeedback} restFeedbackForm={this.props.restFeedbackForm} />} />
